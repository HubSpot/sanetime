...
class SaneTzTimeTest(unittest.TestCase):
    ...
    def test_properties(self):
        ...
        self.assertEquals(st.to_datetime(), st.dt)
        self.assertEquals(st.to_naive_datetime(), st.ndt)
        self.assertEquals(st.to_timezoned_datetime('UTC'), st.utc_dt)
        self.assertEquals(st.to_timezoned_naive_datetime('UTC'), st.utc_ndt)
        self.assertEquals(st.to_timezoned_datetime('America/New_York'), st.ny_dt)
        self.assertEquals(st.to_timezoned_naive_datetime('America/New_York'), st.ny_ndt)
    ...
    def test_to_utc_datetime(self):
        st = sanetztime(JAN_MICROS)
        self.assertEquals(self.utc.localize(datetime(2000,1,1)), st.to_timezoned_datetime('UTC'))
        self.assertEquals(self.utc.localize(datetime(2000,1,1)), st.to_timezoned_datetime(self.utc))
        ...
        st = sanetztime(JUL_MICROS, tz='America/New_York')
        self.assertEquals(self.utc.localize(datetime(2000,7,1)), st.to_timezoned_datetime('UTC'))
        self.assertEquals(self.utc.localize(datetime(2000,7,1)), st.to_timezoned_datetime(self.utc))
    ...
    def test_to_naive_utc_datetime(self):
        st = sanetztime(JAN_MICROS)
        self.assertEquals(datetime(2000,1,1), st.to_timezoned_naive_datetime('UTC'))
        self.assertEquals(datetime(2000,1,1), st.to_timezoned_naive_datetime(self.utc))
        ...
        st = sanetztime(JUL_MICROS, tz='America/New_York')
        self.assertEquals(datetime(2000,7,1), st.to_timezoned_naive_datetime('UTC'))
        self.assertEquals(datetime(2000,7,1), st.to_timezoned_naive_datetime(self.utc))
